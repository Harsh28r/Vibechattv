  ...
  return (
    <main className="min-h-dvh bg-[var(--bg)]">
      ...
      <article className="mx-auto max-w-3xl px-5 pb-20 pt-28 sm:px-8">
        <p className="text-sm font-medium text-[var(--accent)]">Random video chat</p>
        ...
        <p className="mt-5 text-lg leading-relaxed text-[var(--muted)]">
          ...
          in the queue. Text chat rides alongside video. Skip whenever the conversation ends.
        </p>
        <Link
          href="/chat"
          className="mt-8 inline-flex rounded-md bg-[var(--ink)] px-6 py-3 font-semibold text-white hover:opacity-90"
        >
          Open random chat
        </Link>
